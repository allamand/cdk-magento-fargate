...
First If you don't already have one create account on https://devdocs.magento.com/guides/v2.3/install-gde/prereq/connect-auth.html

and then you will create secrets from Magento Access Keys

AWS SecretManager Secret name : **MAGENTO_MARKETPLACE** with value/pair:
